# 쿠버네티스가 편한 이유
    개요
    1. 실제 프로젝트의 구조적 문제 (모니터링/로깅) [기존에 불편했던 문제 요소]
    2. 모니터링 설치 (Loki-Stack) [직접 확인해보기 위해 모니터링 설치]
    3. 쿠버네티스 대표 기능 [쿠버네티스가 편한 이유]
    4. 이전 개발 인프라와 쿠버네티스로 편해진 인프라 [이전과 비교]
